...
class __PyContext(object):
    ...
    def get_raw_financial_data(self, fieldList, stockList, startDate, endDate, report_type='announce_time',data_type='dict'):
        if (report_type != 'announce_time' and report_type != 'report_time'):
            return
        import pandas as pd
    ...
    def get_option_undl(self, opt_code):
        ...
        if inst and 'ExtendInfo' in inst:
            ...
            return ext_info['OptUndlCode'] + '.' + ext_info['OptUndlMarket']
        return
